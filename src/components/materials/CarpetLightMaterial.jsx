...
export default function CarpetLightMaterial({
	lightMapPath = null,
	geometry,
	redLightColor,
	redLightIntensity,
	...
	const colorTexture = useKTX2('/textures/carpet/carpet_color_etc1s.ktx2');
	const roughnessTexture = useKTX2(
		'/textures/carpet/carpet_roughness_etc1s.ktx2'
	);
